    ...
    <div className="flex flex-col pt-20">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="glow-effect text-5xl md:text-8xl mb-4 gradient-title">
              Find Your Dream Ride With AutoHunt
            </h1>
            <p className="text-xl text-black dark:text-white mb-8 max-w-2xl mx-auto">
              Discover & Test Drive Your Perfect Car with AI-Powered Search.{" "}
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {carMakes.map((make) => (
              <Link
                ...
                className="bg-white/20 rounded-lg shadow p-4 text-center hover:shadow-md transition cursor-pointer"
              >
              ...
              >
                <div className="overflow-hidden rounded-lg flex justify-end h-28 mb-4 relative">
                  <Image
                    ...
                    alt={type.name}
                    fill
                    className="object-cover group-hover:scale-105 group-hover:opacity-90 transition duration-300"
                  />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 dark:from-gray-700/40 to-transparent rounded-lg flex items-end">
