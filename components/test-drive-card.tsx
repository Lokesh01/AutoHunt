    ...
    <>
      <Card
        className={`overflow-hidden ${
          isPast
            ? "opacity-80 hover:opacity-100 dark:opacity-60 dark:hover:opacity-100 transition-opacity"
            : ""
        }`}
      >
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="sm:w-1/4 relative h-40 sm:h-auto">
            {booking.car?.images && booking.car.images.length > 0 ? (
              ...
              <div className="w-full h-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                <Car className="h-12 w-12 text-gray-400 dark:text-gray-300" />
              </div>
            )}
          ...
          {showActions && (
            <div className="p-4 border-t sm:border-t-0 sm:border-l sm:w-1/4 sm:flex sm:flex-col sm:justify-center sm:items-center sm:gap-2 sm:space-y-2">
              {/* show notes if any */}
              {booking.notes && (
                <div className="bg-gray-50 dark:bg-gray-700 p-2 rounded text-sm w-full">
